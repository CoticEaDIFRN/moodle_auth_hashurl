...
/**
 * hashurl authentication tests class.
 *
 * @package    auth_hashurl
 * @category   test
 * @copyright  2014 Gilles-Philippe Leblanc <gilles-philippe.leblanc@umontreal.ca>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auth_hashurl_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        set_config('expiration', '1', 'auth_hashurl');
        set_config('expiration_warning', '2', 'auth_hashurl');
        set_config('expirationtime', '30', 'auth_hashurl');
        $this->authplugin->config = get_config(auth_plugin_hashurl::COMPONENT_NAME);
    }
    ...
    public function test_user_update_password() {
        ...
        $this->assertGreaterThanOrEqual($expectedtime, get_user_preferences('auth_hashurl_passwordupdatetime', 0, $user->id));
